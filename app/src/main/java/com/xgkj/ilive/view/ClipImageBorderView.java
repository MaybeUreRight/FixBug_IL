...
import com.xgkj.ilive.utils.Utils;
...
public class ClipImageBorderView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.e("mWidth"," 计算矩形区域的宽度	getWidth()  = " + getWidth()
				+ "  mHorizontalPadding" + mHorizontalPadding + "	mWidth"
				+ mWidth);
		// 计算距离屏幕垂直边界 的边距
		int height = Utils.getHeight(widthProportion,heightProportion, getWidth());
		Log.e("height"," 计算距离屏幕垂直边界 的边距	height Utils.getHeight(16,9,getWidth())  = "
				+ height);
		
		Log.e("height"," getHeight()  = " + getHeight());
