...
public class PublishInformationPresenter implements PublishInformationContract.Presenter {

    private PublishInformationContract.View mPulishInfoView;
    private Context mContext;

    public PublishInformationPresenter(PublishInformationContract.View view,Context context){
        mPulishInfoView = view;
        mContext = context;
    }

    @Override
    public void getInformationList(int type,int records,int pnum) {
        Map<String,Integer> infoMap = new HashMap<>();
        infoMap.put("type",type);
        infoMap.put("records",records);
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String s) {
                        ...
                        if (code == 200){
                            ...
                            mPulishInfoView.getInfomationListFinished(list);
                        }
                    }
    ...
    @Override
    public void getLoadMore(int type, int records, int pnum) {
        Map<String,Integer> infoMap = new HashMap<>();
        infoMap.put("type",type);
        infoMap.put("records",records);
        infoMap.put("pnum",pnum);
                    ...
                    public void call(String s) {
                       // Toast.makeText(mContext, s, Toast.LENGTH_SHORT).show();
                        ...
                        if (code == 200){
                            PublishInformationModel.APIDATABean.RetBean ret = apidata.getRet();
                            List<PublishInformationModel.APIDATABean.RetBean.ListBean> list = ret.getList();
                            mPulishInfoView.getLoadMore(list);
                        }
                    }
                }, new Action1<Throwable>() {
                    @Override
